...
these derivations will be built:
  ...
  /nix/store/gw55rz5fj4q1x4c8khf5jn8dcxjss2qc-example-compact.drv
these paths will be fetched (0.02 MiB download, 0.04 MiB unpacked):
  /nix/store/lph984c2kz24ldp53cnffscj5f358hxk-replace-2.24
...
building path(s) ‘/nix/store/106cgv71403fsrpmvky3046i1rvw7lrb-example-compact’
prepatched GBN: /nix/store/sadnnm26mfddpdip7z75a33fg7k202xp-example-app-0.1.0.0/bin/example-app
   patched GBN: /nix/store/106cgv71403fsrpmvky3046i1rvw7lrb-example-compact/bin/example-app
Scanning binary file /nix/store/106cgv71403fsrpmvky3046i1rvw7lrb-example-compact/bin/example-app (2748880 bytes)...
...
The binary file /nix/store/106cgv71403fsrpmvky3046i1rvw7lrb-example-compact/bin/example-app would have had one string replaced
/nix/store/106cgv71403fsrpmvky3046i1rvw7lrb-example-compact
```
...
2.7M	/nix/store/106cgv71403fsrpmvky3046i1rvw7lrb-example-compact
```
...
these derivations will be built:
  ...
  /nix/store/nik5hjask7dji8h7vqx9ngb7q16gykyd-example-compact.tar.gz.drv
...
...
/nix/store/9g4h69wama4agd9wgqx4s7sam382nx78-example-compact.tar.gz
```
...
| modules/compact              | Minimization of "example-app"                |
...
our application and copying it into the "compact" module.
...
in the statically compiled `example-app` binary.  This is done in the
"compact" module's [builder script][replace-call] using the  `replace-literal`
tool from `nixpkgs`.
