...
* Introduction
  ...
  This provides a replacement/improvement for the built-in Nix support of
  [[direnv][Direnv]].
...
** Next Steps
   ...
   Once activated, you can configure your shell or editors to pick up
   environment settings via Direnv. This repository provides tools for
   integrating with [[../oh-my-zsh/README.org][Zsh via Oh-My-ZSH]] and [[../spacemacs/private/direnv/README.org][Emacs via a Spacemacs layer]].
